...
public class TravelToWorkSiteOrArriveAtSiteActivity extends BaseActivity
        implements OnClickListener, DialogCallback {

    private Button mStartTravel, mCancel, mArrivedOnSite;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.travel_arrived_screen);
        mStartTravel = (Button) findViewById(R.id.start);
        mStartTravel.setOnClickListener(this);
        mArrivedOnSite = (Button) findViewById(R.id.arrivedOnSite);
        mArrivedOnSite.setOnClickListener(this);
    ...
    public void onContinue() {
        if (Utils.isInternetAvailable(mContext)) {
            ...
            Utils.saveTimeSheetInBackLogTable(TravelToWorkSiteOrArriveAtSiteActivity.this,
                    Utils.startTravelTimeRequest,
            ...
            checkOutRemember.setTravelStartedTime(Utils.startTravelTimeRequest
                    .getStarted_at());
            JobViewerDBHandler.saveCheckOutRemember(mContext, checkOutRemember);
            Intent intent = new Intent(TravelToWorkSiteOrArriveAtSiteActivity.this,
    ...
    public void onClick(View view) {
        if (view == mStartTravel)
            ...
            finish();
        else if (view == mArrivedOnSite) {
            Intent workWithNoPhotosintent = new Intent();
            workWithNoPhotosintent.setClass(TravelToWorkSiteOrArriveAtSiteActivity.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Constants.RESULT_CODE_CHANGE_TIME
            ...
            if (Utils.timeSheetRequest != null
                ...
                startEndActvity();
                // String time =
                // data.getExtras().get(Constants.TIME).toString();
            ...
            if (!Utils.isInternetAvailable(this)) {
                ...
                Utils.saveTimeSheetInBackLogTable(
                        TravelToWorkSiteOrArriveAtSiteActivity.this,
                        Utils.startTravelTimeRequest,
    ...
    private void executeStartTravelService() {
        if (Utils.isInternetAvailable(TravelToWorkSiteOrArriveAtSiteActivity.this)) {
    ...
    private void insertStartTravelTimeRequestInDB() {
        ...
        BreakShiftTravelCall breakShiftTravelCall = JobViewerDBHandler
                .getBreakShiftTravelCall(TravelToWorkSiteOrArriveAtSiteActivity.this);
        ...
        JobViewerDBHandler.saveBreakShiftTravelCall(
                TravelToWorkSiteOrArriveAtSiteActivity.this, breakShiftTravelCall);
