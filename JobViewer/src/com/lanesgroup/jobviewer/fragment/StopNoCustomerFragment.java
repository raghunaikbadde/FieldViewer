...
public class StopNoCustomerFragment extends Fragment implements
		OnClickListener, ConfirmStopWork {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRootView = inflater.inflate(R.layout.risk_assessment_stop_screen,
				container, false);
	...
	public void onClick(View v) {
		if (v.getId() == mStopButton.getId()) {
			...
			ConfirmWorkStopDialog mDialog = new ConfirmWorkStopDialog(
					getActivity(),
					new ConfirmWorkStopDialog.ConfirmWorkStopDialogCallback() {
						@Override
	...
	private void saveCreatedWorkInBackLogDb() {
		...
		backLogRequest.setRequestApi(CommsConstant.HOST
				...
				+ "/"
				+ mSharedPref.getSharedPref(getActivity()).getString(
