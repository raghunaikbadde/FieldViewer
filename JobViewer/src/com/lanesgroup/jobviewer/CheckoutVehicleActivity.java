            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case HttpConnection.DID_ERROR:
                        ...
                        if (exception.getMessage().equalsIgnoreCase("Vehicle entry has been saved successfully")) {
                            ExceptionHandler.showException(context, exception, "Info", new IDialogListener() {
                                @Override
                            ...
                            ExceptionHandler.showException(context, exception, "Info", null);
                            saveVechicleCheckOutInDB();
                        }
