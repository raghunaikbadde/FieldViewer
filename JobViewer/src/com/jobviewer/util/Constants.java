...
public class Constants {
    ...
    public static final String PROGRESS_1_TO_3 = "Steps 1 of 3";
    ...
    public static final String KEY_ABSTRACTION_VALUE = "key_abstraction_value";
    public static final String KEY_IS_FROM_POLLUTION = "key_is_from_pollution";
    public static final String KEY_FROM_WORK = "key_from_work";
    public static final String KEY_VISTECID = "key_vistecid";
    ...
    public static final String ACTUAL_TRAVEL_START_TIME_FLAG_JSON = "ACTUAL_TRAVEL_START_TIME_FLAG_JSON";
