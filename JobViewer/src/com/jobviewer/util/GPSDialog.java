...
public class GPSDialog extends Dialog implements android.view.View.OnClickListener{
	...
	private void updateDetailsOnUI(Context context){
		mHeaderTxt.setText(context.getResources().getString(R.string.gpsSwitchedOff));
		mMessageTxt.setText(context.getResources().getString(R.string.gpsSwitchedOffMessage));
		mExitButton.setText(context.getResources().getString(R.string.exitButtonText));
		mSettingsButton.setText(context.getResources().getString(R.string.settignsButtonText));
