...
public class WorkRequest {
	...
	private ArrayList<ActivityTypeDetailsModel> activity_type_details;
	...
	public String getAbstract_water() {
		return abstract_water;
	}

	public void setAbstract_water(String abstract_water) {
		this.abstract_water = abstract_water;
	}

	public ArrayList<ActivityTypeDetailsModel> getActivity_type_details() {
		return activity_type_details;
	}

	public void setActivity_type_details(
			ArrayList<ActivityTypeDetailsModel> activity_type_details) {
		this.activity_type_details = activity_type_details;
	}
